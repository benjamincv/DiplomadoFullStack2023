...
window.onload = function () {
  ...
  $(function() {
    $(document).on('click', 'input[type="button"]', function(event) {
      let id = this.id;
      var play = playStations.find(a => a.noSerie==id);
      sessionStorage.setItem('noSerie',id);
      sessionStorage.setItem('nombre',play.nombre);
      sessionStorage.setItem('paisOrigen',play.paisOrigen);
      sessionStorage.setItem('year',play.year);
